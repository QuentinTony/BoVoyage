...
<body>
	...
	<div class="panel panel-info"
		...
		<div class="panel-body">
			<form>
				<label for="continent">Continent :</label> <br /> <select
					class="form-control" id="continent" onclick="liste()">
					<option>Sélectionnez un continent</option>
					<option value="europe">Europe</option>
					<option value="asie">Asie</option>
					<option value="amerique">Amérique</option>

				</select> <br /> <label id="label" for="paysE;paysAs;paysAm"
					style="display: none">Pays : </label> <select class="form-control"
					id="paysE" style="display: none" onclick="liste2()">
					<option>Sélectionnez un pays</option>
					<option value="Norvège">Norvège</option>
					<option value="Finlande">Finlande</option>
					<option value="Suède">Suède</option>
				</select> <select class="form-control" id="paysAs" style="display: none;"
					onclick="liste3()">
					<option>Sélectionnez un pays</option>
					<option value="Sibérie">Sibérie</option>
					<option value="Chine">Chine</option>
				</select> <select class="form-control" id="paysAm" style="display: none;"
					onclick="liste4()">
					<option>Sélectionnez un pays</option>
					<option value="Canada">Canada</option>
					<option value="Alaska">Alaska</option>
				</select> <br /> <label id="labelville" for="ville" style="display: none">Ville
					: </label> <select class="form-control" id="villeNorvege"
					style="display: none;" onclick="liste5()">
					<option>Sélectionnez une ville</option>
					<option value="Oslo">Olso</option>
					<option value="Bergen">Bergen</option>
				</select> <select class="form-control" id="villeFinlande"
					style="display: none;" onclick="liste6()">
					<option>Sélectionnez une ville</option>
					<option value="Helsinki">Helsinki</option>
					<option value="village">Village du Père Noël</option>
				</select> <select class="form-control" id="villeSuede" style="display: none;"
					onclick="liste7()">
					<option>Sélectionnez une ville</option>
					<option value=Stockholm>Stockholm</option>
					<option value="Uppsala">Uppsala</option>
				</select> <select class="form-control" id="villeSibérie"
					style="display: none;" onclick="liste8()">
					<option>Sélectionnez une ville</option>
					<option value="Omsk">Omsk</option>
					<option value="Irkoutsk">Irkoutsk</option>
				</select> <select class="form-control" id="villeChine" style="display: none;"
					onclick="liste9()">
					<option>Sélectionnez une ville</option>
					<option value="Xuexiang">Xuexiang</option>
				</select> <select class="form-control" id="villeCanada"
					style="display: none;" onclick="liste10()">
					<option>Sélectionnez une ville</option>
					<option value="Quebec">Québec</option>
					<option value="Montreal">Montréal</option>
				</select> <select class="form-control" id="villeAlaska"
				...
				<div
					...
					<label id="labellat" for="lat" style="display: none">Latitude
						...
						style="display: none" disabled="disabled" style="width: 30%;"> <br /> <br />
